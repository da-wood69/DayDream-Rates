...
# Comprehensive country mapping with ISO3 codes, full names, and flag emojis
country_mapping = {
    "ABW": {"name": "Aruba", "flag": "🇦🇼"},
...
def get_country_info(country_code):
    ...
    return country_mapping.get(country_code.upper(), {"name": country_code, "flag": "🏳️"})

def save_country_mapping_json():
    """Save the country mapping to a JSON file for easy loading"""
    with open('country_mapping.json', 'w', encoding='utf-8') as f:
        json.dump(country_mapping, f, ensure_ascii=False, indent=2)

if __name__ == "__main__":
    save_country_mapping_json()
    print("Country mapping JSON file created successfully!")